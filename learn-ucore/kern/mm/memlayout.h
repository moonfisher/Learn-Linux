...
/* *
 * Virtual memory map base on 128M physical memory:             Permissions
 *                                                              kernel/user
 *
 *  4G ---------------------> +---------------------------------+ 0xFFFFFFFF
 *                            |                                 |
 ...
 *                            |                                 |
 *                            |                                 |
 *  physical memory end ----> |---------------------------------| 0xC8000000 128M
 *                            |                                 |
 *  free memory end --------> |---------------------------------| 0xC7FE0000
 *                            |                                 |
 *                            |   free memory = 0x7d63 * 4k     |
 *                            |                                 |
 *  page table end ---------> |---------------------------------| 0xC035B000
 *                            |  page table 1 ~ 223 (223 * 4k)  |
 *  free memory start ------> |---------------------------------| 0xC027D000
 *                            |                                 |
 *  pages end --------------> |---------------------------------| 0xC027CB80
 *                            |  sizeof(Page) * npage(0x7fe0)   |
 *  pages start ------------> |---------------------------------| 0xC015D000
 *                            |                                 |
 *  end --------------------> |---------------------------------| 0xC015C384
 *                            |                                 |
 *  ts ---------------------> |---------------------------------| 0xC0158FC0
 ...
 *  idt --------------------> |---------------------------------| 0xC0158780
 *                            |                                 |
 *  edata end --------------> |---------------------------------| 0xC0158000
 *                            |            page table 0         |
 *  __boot_pt1 -------------> |---------------------------------| 0xC0157000
 *                            |     KERNBASE page directory     |
 ...
 *                            |                                 |
 *  etext end --------------> |---------------------------------| 0xC0114541
 *                            |                                 |
 *  vector255 --------------> |---------------------------------| 0xC0103753
 *                            |         ISR's entry addrs       |
 *  vector0 ----------------> |---------------------------------| 0xC0102CEF
 *                            |                                 |
