 ...
 *                            |                                 |
 *                            |  free memory = 0x0001FFE0 * 4k  |
 *                            |                                 |
 *  page table end ---------> |---------------------------------| 0xC035B000
 *                            |  page table 1 ~ 223 (223 * 4k)  |
 *  free memory start ------> |---------------------------------| 0xC05E0000
 *                            |                                 |
 *  pages end (free end) ---> |---------------------------------| 0xC05DFB80
 *                            |                                 |
 *                            | sizeof(Page) * npage(0x0001FFE0)|
 *                            |                                 |
 *  free memory page start -> |---------------------------------| 0xC016D380
 *                            |                                 |
 *  pages start ------------> |---------------------------------| 0xC0160000
 *                            |                                 |
 *  end --------------------> |---------------------------------| 0xC015F384
 *                            |                                 |
 *  ts ---------------------> |---------------------------------| 0xC015BFC0
 ...
 *  idt --------------------> |---------------------------------| 0xC015B780
 *                            |                                 |
 *  edata end --------------> |---------------------------------| 0xC015B000
 *                            |            page table 3         |
 *  __boot_pt4 -------------> |---------------------------------| 0xC015A000
 *                            |            page table 2         |
 *  __boot_pt3 -------------> |---------------------------------| 0xC0159000
 *                            |            page table 1         |
 *  __boot_pt2 -------------> |---------------------------------| 0xC0158000
 *                            |            page table 0         |
